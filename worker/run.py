...
def run():
    ...
    challenge_id = 1
    challenge_phase = "public"  # Add the challenge phase codename to be tested
    annotation_file_path = "{}/annotations/private_solution.csv".format(
        current_working_directory
    )  # Add the test annotation file path
    user_submission_file_path = "{}/challenge_data/public_sample_submission.csv".format(
        current_working_directory
